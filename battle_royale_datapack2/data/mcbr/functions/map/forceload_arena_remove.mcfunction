...
# Remove forceload from the arena area (radius 150 blocks around the dynamic center)
execute at @e[type=minecraft:marker,tag=mcbr_forceload_helper,limit=1] run forceload remove ~-150 ~-150 ~150 ~150
