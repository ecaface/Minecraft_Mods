...
execute align xyz positioned ~ ~-1 ~-2 run summon marker ~0.5 ~0.5 ~0.5 {Tags:["mcbr_spawn_cache_support"]}
...
scoreboard players remove @s mcbr.scz 2
...
scoreboard players remove @s mcbr.ssz 2
...
scoreboard players remove @s mcbr.sgz 1
