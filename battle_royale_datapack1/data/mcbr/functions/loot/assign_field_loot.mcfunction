...
# Rare selection from the central candidates only.
execute if score $chest_player_count mcbr.tmp matches 2..4 run tag @e[type=minecraft:marker,tag=mcbr_chest_candidate,tag=mcbr_chest_center,sort=random,limit=1] add mcbr_chest_rare
execute if score $chest_player_count mcbr.tmp matches 4 run tag @e[type=minecraft:marker,tag=mcbr_chest_candidate,tag=mcbr_chest_center,tag=!mcbr_chest_rare,sort=random,limit=1] add mcbr_chest_rare
...
tag @e[type=minecraft:marker,tag=mcbr_chest_candidate,tag=mcbr_chest_common] add mcbr_chest_active
